...
public class MainAppMobile extends PreventivoAppMobile{
	...
	public int getGiornatePubblicazioneApp() {
		return giornatePubblicazioneApp;
	}
	...
	public int getGiornateFunzioniGeneriche() {
		return giornateFunzioniGeneriche;
	}
	...
	public static void main(String[] args) {
		...
		mobile.setGooglePlay("Il cliente dovrà fornire l'account aziendare per la publicazione su Google Play");
		mobile.setAppleStore("Il cliente dovrà fornire i dati relativi all'upload dell'app su TestFlight e su Apple connect");
		mobile.setResponsiveApp("L'app mobile dovrà essere rilasciata per dispositivi mobile-tablet-web");
		mobile.setMultiLanguages("L'app dovrà essere disponibile in lingua italiana e inglese");
		mobile.setApiService("Il servizio web principale dell'app è: https://api.service.mobile");
		mobile.setWaitingTimesTest("La previsione della fase di test dell'app si svolgerà in 5 giorni");
		mobile.setWaitingTimes("L'app mobile verrà rilasciata sugli store dopo la fase di test nei tempi stabiliti dagli stores");
		...
		System.out.println("TOTALE SVILUPPO APP: €" + mobile.getTotalePreventivo());
